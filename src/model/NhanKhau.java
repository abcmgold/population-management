...
public class NhanKhau {
    ...
    public NhanKhau(String ho_ten, String ngay_sinh, String noi_sinh, String nguyen_quan, String dan_toc, String nghe_nghiep, String noi_lam_viec, String CCCD, String ngay_cap, String noi_cap, String ngay_dang_ki_thuong_tru, String dia_chi_cu) {
        this.ho_ten = ho_ten;
    ...
    public NhanKhau(int ID,String ho_ten, String ngay_sinh, String gioi_Tinh, String dia_chi_cu) {
        this.ID = ID;
        this.ho_ten = ho_ten;
        this.ngay_sinh = ngay_sinh;
