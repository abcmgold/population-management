...
public class NhanKhauModel {
    ...
    public NhanKhauModel(int ID, String maNhanKhau, String hoTen, String bietDanh, Date namSinh, String gioiTinh, String noiSinh, String nguyenQuan, String danToc, String tonGiao, String quocTich, String soHoChieu, String noiThuongTru, String diaChiHienNay, String trinhDoHocVan, String trinhDoChuyenMon, String bietTiengDanToc, String trinhDoNgoaiNgu, String ngheNghiep, String noiLamViec, String tienAn, Date ngayChuyenDen, String lyDoChuyenDen, Date ngayChuyenDi, String lyDoChuyenDi, String diaChiMoi, Date ngayTao, int idNguoiTao, Date ngayXoa, int idNguoiXoa, String lyDoXoa, String ghiChu) {
        this.ID = ID;
